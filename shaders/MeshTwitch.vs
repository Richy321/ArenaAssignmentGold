...
{
  vec4 newPos = vec4(
  pos.x + (normal.x * mix(fromExtrudeUniform, toExtrudeUniform, progress)),
  pos.y + (normal.y * mix(fromExtrudeUniform, toExtrudeUniform, progress)),
  pos.z + (normal.z * mix(fromExtrudeUniform, toExtrudeUniform, progress)),
  1
  );
